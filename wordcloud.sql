...
go
 ...
 --select  'Family',max(noisewordid)+1 from Junk_word_clouds_list
		...
		--create table Junk_word_clouds_list(NoiseWordID int,NoiseWord nvarchar(1000)) ;
		--create   table Top_n_word_clouds_list(id int not null identity(1,1) primary key,word nvarchar(1000) );
...
*/
ALTER proc [dbo].[P_Split_String_2_Words]
(
